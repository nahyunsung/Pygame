...
#변수 초기화
WHITE = (255,255,255)
SCREEN_WIDIH = SCREEN_HEIGHT = 750
SCREEN_SIZE = (SCREEN_WIDIH, SCREEN_HEIGHT)
...
def main():
    ...
    def redraw_window():
        ...
        WIN.blit(level_label,(SCREEN_WIDIH-level_label.get_width()-10,10))
    ...
    while run:
        ...
        if keys[pygame.K_a] and player.x-player_vel > 0:
            player.x -= player_vel
        if keys[pygame.K_d] and player.x+player_vel < SCREEN_WIDIH-player.get_width():
            player.x += player_vel
