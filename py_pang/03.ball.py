...
screen_width = 640
screen_height = 480
screen_size = (screen_width, screen_height) # 튜플형으로 화면 크기 저장
screen = pygame.display.set_mode(screen_size)
pygame.display.set_caption("PYPANG!")

# 배경 이미지
cu_path = os.path.dirname(__file__) # 현재 팡리 폴더 경로
img_path = os.path.join(cu_path, "imge")
...
while running:
    ...
    # 게임 캐릭터 위치 업데이트
    if character_x_pos + character_speed < 0 or character_x_pos + character_speed > screen_width - character_width:
        character_speed = 0
